...
func (*Port) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{0}
}
...
func (*Networks) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{1}
}
...
func (*Resources) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{2}
}
...
func (*LogConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{3}
}
...
func (*TaskInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{4}
}
...
func (*TaskDir) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{5}
}
...
func (*TaskEnv) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{6}
}
...
func (*ExecContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{7}
}
...
func (*StartRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{8}
}
...
func (*DriverNetwork) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{9}
}
...
func (*StartResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{10}
}
...
type PluginReattachInfo struct {
	Pid                  uint32   `protobuf:"varint,1,opt,name=pid,proto3" json:"pid,omitempty"`
	AddressNetwork       string   `protobuf:"bytes,2,opt,name=address_network,json=addressNetwork,proto3" json:"address_network,omitempty"`
...
func (m *PluginReattachInfo) Reset()         { *m = PluginReattachInfo{} }
func (m *PluginReattachInfo) String() string { return proto.CompactTextString(m) }
func (*PluginReattachInfo) ProtoMessage()    {}
func (*PluginReattachInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{11}
}
func (m *PluginReattachInfo) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_PluginReattachInfo.Unmarshal(m, b)
}
func (m *PluginReattachInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_PluginReattachInfo.Marshal(b, m, deterministic)
}
func (dst *PluginReattachInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PluginReattachInfo.Merge(dst, src)
}
func (m *PluginReattachInfo) XXX_Size() int {
	return xxx_messageInfo_PluginReattachInfo.Size(m)
}
func (m *PluginReattachInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_PluginReattachInfo.DiscardUnknown(m)
}

var xxx_messageInfo_PluginReattachInfo proto.InternalMessageInfo

func (m *PluginReattachInfo) GetPid() uint32 {
	if m != nil {
		return m.Pid
	}
	return 0
...
func (m *PluginReattachInfo) GetAddressNetwork() string {
	if m != nil {
		return m.AddressNetwork
	}
	return ""
}

func (m *PluginReattachInfo) GetAddressName() string {
	if m != nil {
...
type TaskState struct {
	...
	ReattachInfo         *PluginReattachInfo `protobuf:"bytes,2,opt,name=reattach_info,json=reattachInfo,proto3" json:"reattach_info,omitempty"`
	KillTimeout          *duration.Duration  `protobuf:"bytes,3,opt,name=kill_timeout,json=killTimeout,proto3" json:"kill_timeout,omitempty"`
	MaxKillTimeout       *duration.Duration  `protobuf:"bytes,4,opt,name=max_kill_timeout,json=maxKillTimeout,proto3" json:"max_kill_timeout,omitempty"`
	ReattachMeta         *_struct.Struct     `protobuf:"bytes,5,opt,name=reattach_meta,json=reattachMeta,proto3" json:"reattach_meta,omitempty"`
	TaskDir              string              `protobuf:"bytes,6,opt,name=task_dir,json=taskDir,proto3" json:"task_dir,omitempty"`
	...
	MinPort              uint32              `protobuf:"varint,9,opt,name=min_port,json=minPort,proto3" json:"min_port,omitempty"`
	MaxPort              uint32              `protobuf:"varint,10,opt,name=max_port,json=maxPort,proto3" json:"max_port,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (*TaskState) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{12}
}
...
func (m *TaskState) GetReattachInfo() *PluginReattachInfo {
	if m != nil {
		return m.ReattachInfo
	}
	return nil
}

func (m *TaskState) GetKillTimeout() *duration.Duration {
	if m != nil {
...
func (m *TaskState) GetMaxKillTimeout() *duration.Duration {
	if m != nil {
		return m.MaxKillTimeout
	}
	return nil
}

func (m *TaskState) GetReattachMeta() *_struct.Struct {
	if m != nil {
		return m.ReattachMeta
	}
	return nil
}

func (m *TaskState) GetTaskDir() string {
	if m != nil {
		return m.TaskDir
	}
	return ""
...
func (m *TaskState) GetLogDir() string {
	if m != nil {
		return m.LogDir
	}
	return ""
...
func (m *TaskState) GetLogLevel() string {
	if m != nil {
		return m.LogLevel
	}
	return ""
...
func (m *TaskState) GetMinPort() uint32 {
	if m != nil {
		return m.MinPort
	}
	return 0
...
func (m *TaskState) GetMaxPort() uint32 {
	if m != nil {
		return m.MaxPort
	}
	return 0
...
func (*RestoreRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{13}
}
...
func (m *RestoreRequest) GetTaskStates() []*TaskState {
	if m != nil {
		return m.TaskStates
	}
	return nil
...
func (m *TaskRestoreResponse) Reset()         { *m = TaskRestoreResponse{} }
func (m *TaskRestoreResponse) String() string { return proto.CompactTextString(m) }
func (*TaskRestoreResponse) ProtoMessage()    {}
func (*TaskRestoreResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{14}
}
func (m *TaskRestoreResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TaskRestoreResponse.Unmarshal(m, b)
}
func (m *TaskRestoreResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TaskRestoreResponse.Marshal(b, m, deterministic)
}
func (dst *TaskRestoreResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TaskRestoreResponse.Merge(dst, src)
}
func (m *TaskRestoreResponse) XXX_Size() int {
	return xxx_messageInfo_TaskRestoreResponse.Size(m)
}
func (m *TaskRestoreResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_TaskRestoreResponse.DiscardUnknown(m)
}

var xxx_messageInfo_TaskRestoreResponse proto.InternalMessageInfo

func (m *TaskRestoreResponse) GetTaskId() string {
	if m != nil {
		return m.TaskId
	}
	return ""
...
func (m *TaskRestoreResponse) GetErrorMessage() string {
	if m != nil {
...
type RestoreResponse struct {
	RestoreResults       []*TaskRestoreResponse `protobuf:"bytes,1,rep,name=restore_results,json=restoreResults,proto3" json:"restore_results,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (*RestoreResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{15}
}
...
func (m *RestoreResponse) GetRestoreResults() []*TaskRestoreResponse {
	if m != nil {
		return m.RestoreResults
	}
	return nil
}
...
func (*Empty) Descriptor() ([]byte, []int) {
	return fileDescriptor_raw_exec_184aeacb79fc9b64, []int{16}
}
...
func init() {
	...
	proto.RegisterType((*PluginReattachInfo)(nil), "proto.PluginReattachInfo")
	proto.RegisterType((*TaskState)(nil), "proto.TaskState")
	proto.RegisterType((*RestoreRequest)(nil), "proto.RestoreRequest")
	proto.RegisterType((*TaskRestoreResponse)(nil), "proto.TaskRestoreResponse")
	proto.RegisterType((*RestoreResponse)(nil), "proto.RestoreResponse")
...
func (c *rawExecClient) Restore(ctx context.Context, in *RestoreRequest, opts ...grpc.CallOption) (*RestoreResponse, error) {
	out := new(RestoreResponse)
	err := c.cc.Invoke(ctx, "/proto.RawExec/Restore", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RawExec_Restore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RestoreRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RawExecServer).Restore(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.RawExec/Restore",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RawExecServer).Restore(ctx, req.(*RestoreRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _RawExec_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Restore",
			Handler:    _RawExec_Restore_Handler,
		},
	},
...
func init() { proto.RegisterFile("raw-exec.proto", fileDescriptor_raw_exec_184aeacb79fc9b64) }

var fileDescriptor_raw_exec_184aeacb79fc9b64 = []byte{
	...
	,
}
